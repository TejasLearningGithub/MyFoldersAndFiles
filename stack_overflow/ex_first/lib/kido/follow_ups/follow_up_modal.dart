class FollowUpsModal {
  String? message;
  Data? data;
  int? code;
  bool? success;

  FollowUpsModal({this.message, this.data, this.code, this.success});

  FollowUpsModal.fromJson(Map<String, dynamic> json) {
...
class Followups {
  ...
  Followups.fromJson(Map<String, dynamic> json) {
    ...
    centerId = json['center_id'] != null
        ? CenterId.fromJson(json['center_id'])
        : null;
    leadNo = json['lead_no'];
    leadName = json['lead_name'];
    childName = json['child_name'];
    leadId =
        json['lead_id'] != null ? LeadId.fromJson(json['lead_id']) : null;
